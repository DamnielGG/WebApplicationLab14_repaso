...
namespace WebApplicationLab14_repaso
{
    public partial class Eliminar : System.Web.UI.Page
    {
        ...
        {
            CodigoLibros = TextBoxCodigoLibro.Text;
            ...
            foreach (var u in DatLib)
            {
                ...
                if (eliminar != null)
                {
                    TextBoxNombreLibro.Text = eliminar.NameProducto;
                    TextBoxDescripcionLibro.Text = eliminar.DescriProducto;
                    disponible = true;
